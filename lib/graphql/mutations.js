...
const createCollectiveFromGithubQuery = gqlV2`
...
export const addCreateCollectiveMutation = gql(createCollectiveQuery, {
  options: {
...
export const addCreateCollectiveFromGithubMutation = gql(createCollectiveFromGithubQuery, {
  options: {
    context: { apiVersion: '2' },
  },
  props: ({ mutate }) => ({
